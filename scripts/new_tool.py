...
Substitutes browser-artifact-analyzer, Browser Artifact Analyzer, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("browser_artifact_analyzer", "{slug_underscore}"),
    ("browser-artifact-analyzer", "{slug_kebab}"),
    ("Browser Artifact Analyzer", "{name}"),
    ("browser-artifact-analyzer", "{slug_kebab}"),
    ("Browser Artifact Analyzer", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
